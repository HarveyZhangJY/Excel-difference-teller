...
while 1:
    ...
    print("There is(are) %d row(s) in " % count1+filename1+".xls that has(have) difference")
    print(filename2 + ".xls中有%d行存在差异：" % count2)
    print("There is(are) %d row(s) in " % count2+filename2+".xls that has(have) difference")
